<template>
	<view v-if="configInfo.small_switch ==0" style="position: fixed;top: 0;bottom: 0;right:0;left: 0;background-image: url('http://campus.51job.com/yonyou/img/index_bg.png');background-size: 100% 100%;">
		
		<image class="login-logo" :style="{'margin-top':navHeight}" src="http://qiniugw.sdwanyue.com/x_about_wylog.png" mode=""></image>
		<image v-if="configInfo.small_switch == 0" class="login-logo-text" src=""></image>
