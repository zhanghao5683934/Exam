<template>
	<view>
		...
		<form @submit="submit">
			...
			<view class="my_update-li">
				<view class="my_update-li-name">所属年级</view>
				<picker :range="list" @change="partyChange">
					<view>
						<input class="my_update-li-input" disabled type="text" :value="userInfo.branch" name="party_z" />
					</view>
				</picker>
				
			</view>
			<view class="my_update-li">
				<view class="my_update-li-name">所属学校</view>
				<picker :range="list1" @change="partyChange1">
					<view>
						<input class="my_update-li-input" disabled type="text" :value="userInfo.post" name="party_w" />
					</view>
				</picker>
			</view>
...
<script>
	...
	export default {
		...
		onLoad(){
			this.list = app.globalData.configInfo.partylist.partybranch.value;
			this.list_key = app.globalData.configInfo.partylist.partybranch.key;
			this.list1 = app.globalData.configInfo.partylist.partypost.value;
			this.list1_key = app.globalData.configInfo.partylist.partypost.key;
