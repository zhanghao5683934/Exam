<template>
	<view>
		...
		<view class="index-article">
			<view class="index-article-top">
				<text class="index-article-top-shu"></text>
				<text v-if="configInfo.small_switch == 0" class="index-article-top-text">{{lession_title}}</text>
				<text v-if="configInfo.small_switch == 1" class="index-article-top-text">学习之窗</text>
				<image class="index-article-top-zhe" src="/static/images/zhe.png"></image>
				<view v-if="configInfo.small_switch == 0" class="index-article-top-more" @click="goM1">更多</view>
			</view>
			<view class="index-article-list">
		...
		<view class="index-article">
			<view class="index-article-top">
				<text class="index-article-top-shu"></text>
				<text v-if="configInfo.small_switch" class="index-article-top-text">{{duwu_name}}</text>
				<image class="index-article-top-zhe" src="/static/images/zhe.png"></image>
				<view class="index-article-top-more" @click="goM2">更多</view>
			</view>
			<view class="index-article-list">
				<studyList :listType="listType" :list="list1"></studyList>
			</view>
		</view>
